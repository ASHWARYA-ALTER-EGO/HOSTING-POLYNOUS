...
function Styles() {
  return (
    <style>{`
      @import url('https://fonts.googleapis.com/css2?family=Sora:wght@400;500;600;700;800&family=JetBrains+Mono:wght@400;500&family=Hanken+Grotesk:wght@400;500;600&family=Material+Symbols+Outlined&display=swap');
      ...
      <main style={{
        ...
        <header style={{ marginBottom: 44, paddingTop: 8 }}>
          ...
          <h1 style={{
            ...
            fontWeight: 800, color: C.silverBright,
            letterSpacing: "-0.04em",
            textShadow: "0 0 48px rgba(200,205,214,0.14)",
            margin: 0,
          }}>
            Settings
          </h1>
          <p style={{
            ...
            color: C.onSurfaceVariant, marginTop: 10, lineHeight: 1.5,
          }}>
